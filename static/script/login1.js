...
// Attach event listener to the "Back to Signup" button
const backToSignupButton = document.querySelector('.login-back');
if (backToSignupButton) {
    backToSignupButton.addEventListener('click', handleLoginClick);
}
